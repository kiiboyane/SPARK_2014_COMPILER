...
typedef enum CODES_ERREURS{
    ...
    ERR_AFFEC,
    ERR_CONSTS,ERR_ID_PROCEDURE,ERR_PROCEDURE,ERR_IS,
    ...
    PROCEDURE_NAME_ERR , PROCEDURE_END_NAME_ERR,VARIABLE_NAME_ERR,
    CHARACTER_ERR,VARIABLE_NOT_FOUND_ERR,NOT_INITIALIZED_ERR,TYPE_DIFFERENT_ERR,
    CONSTANT_ERR,PROCEDURE_AFF_ERR
